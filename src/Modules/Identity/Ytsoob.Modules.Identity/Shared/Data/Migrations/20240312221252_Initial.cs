...
namespace Ytsoob.Modules.Identity.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    lastloggedinat = table.Column<DateTime>(name: "last_logged_in_at", type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sentat = table.Column<DateTime>(name: "sent_at", type: "timestamp without time zone", nullable: false),
                    usedat = table.Column<DateTime>(name: "used_at", type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    expiredat = table.Column<DateTime>(name: "expired_at", type: "timestamp without time zone", nullable: false),
