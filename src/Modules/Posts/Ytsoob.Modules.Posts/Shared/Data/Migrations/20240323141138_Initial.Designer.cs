...
namespace Ytsoob.Modules.Posts.Shared.Data.Migrations
{
    ...
    [Migration("20240323141138_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Comments.Models.BaseComment", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Contents.Models.Content", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Polls.Models.Option", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Polls.Models.Poll", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Polls.Models.Voter", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Posts.Models.Post", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Reactions.Models.Reaction", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Reactions.Models.ReactionStats", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Subscriptions.Models.Subscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Ytsoobers.Models.Ytsoober", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Comments.Models.Comment", b =>
                {
                    b.HasBaseType("Ytsoob.Modules.Posts.Comments.Models.BaseComment");

                    b.HasDiscriminator().HasValue("Comment");
                });

            modelBuilder.Entity("Ytsoob.Modules.Posts.Comments.Models.RepliedComment", b =>
                {
                    b.HasBaseType("Ytsoob.Modules.Posts.Comments.Models.BaseComment");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Comments.Models.BaseComment", b =>
                {
                    b.HasOne("Ytsoob.Modules.Posts.Reactions.Models.ReactionStats", "ReactionStats")
                        .WithMany()
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Comments.ValueObjects.CommentContent", "Content", b1 =>
                        {
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Contents.Models.Content", b =>
                {
                    b.HasOne("Ytsoob.Modules.Posts.Posts.Models.Post", null)
                        .WithOne("Content")
                        .HasForeignKey("Ytsoob.Modules.Posts.Contents.Models.Content", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contents_posts_post_id");

                    b.OwnsOne("Ytsoob.Modules.Posts.Contents.ValueObjects.ContentText", "ContentText", b1 =>
                        {
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Polls.Models.Option", b =>
                {
                    b.HasOne("Ytsoob.Modules.Posts.Polls.Models.Poll", "Poll")
                        .WithMany("Options")
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Polls.ValueObjects.Fiction", "Fiction", b1 =>
                        {
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Polls.ValueObjects.OptionCount", "Count", b1 =>
                        {
                            b1.Property<long>("OptionId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Polls.ValueObjects.OptionTitle", "Title", b1 =>
                        {
                            b1.Property<long>("OptionId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Polls.Models.Poll", b =>
                {
                    b.HasOne("Ytsoob.Modules.Posts.Posts.Models.Post", "Post")
                        .WithOne("Poll")
                        .HasForeignKey("Ytsoob.Modules.Posts.Polls.Models.Poll", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_polls_posts_post_id");

                    b.OwnsOne("Ytsoob.Modules.Posts.Polls.ValueObjects.Question", "Question", b1 =>
                        {
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Polls.ValueObjects.TotalCountPoll", "TotalCountPoll", b1 =>
                        {
                            b1.Property<long>("PollId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Polls.Models.Voter", b =>
                {
                    b.HasOne("Ytsoob.Modules.Posts.Polls.Models.Option", "Option")
                        .WithMany()
                        .HasForeignKey("OptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Ytsoob.Modules.Posts.Ytsoobers.Models.Ytsoober", "Ytsoober")
                        .WithMany()
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Posts.Models.Post", b =>
                {
                    ...
                    b.HasOne("Ytsoob.Modules.Posts.Subscriptions.Models.Subscription", "Subscription")
                        .WithMany()
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Reactions.Models.ReactionStats", b =>
                {
                    b.OwnsOne("Ytsoob.Modules.Posts.Reactions.ValueObjects.ReactionNumber", "Angry", b1 =>
                        {
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Reactions.ValueObjects.ReactionNumber", "Crying", b1 =>
                        {
                            b1.Property<long>("ReactionStatsId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Reactions.ValueObjects.ReactionNumber", "Dislike", b1 =>
                        {
                            b1.Property<long>("ReactionStatsId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Reactions.ValueObjects.ReactionNumber", "Happy", b1 =>
                        {
                            b1.Property<long>("ReactionStatsId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Reactions.ValueObjects.ReactionNumber", "Like", b1 =>
                        {
                            b1.Property<long>("ReactionStatsId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Ytsoob.Modules.Posts.Reactions.ValueObjects.ReactionNumber", "Wonder", b1 =>
                        {
                            b1.Property<long>("ReactionStatsId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Ytsoob.Modules.Posts.Comments.Models.RepliedComment", b =>
                {
                    b.HasOne("Ytsoob.Modules.Posts.Comments.Models.Comment", "Comment")
                    ...
                    b.HasOne("Ytsoob.Modules.Posts.Comments.Models.BaseComment", "RepliedToComment")
                        .WithMany()
