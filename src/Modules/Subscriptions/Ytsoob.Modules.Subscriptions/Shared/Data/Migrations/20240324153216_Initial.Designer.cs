...
namespace Ytsoob.Modules.Subscriptions.Shared.Data.Migrations
{
    ...
    [Migration("20240324153216_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ytsoob.Modules.Subscriptions.Subscriptions.Models.Subscription", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("Ytsoob.Modules.Subscriptions.Ytsoobers.Models.Ytsoober", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Ytsoob.Modules.Subscriptions.Subscriptions.Models.Subscription", b =>
                {
                    b.HasOne("Ytsoob.Modules.Subscriptions.Ytsoobers.Models.Ytsoober", "Ytsoober")
                        .WithMany()
                    ...
                    b.OwnsOne("Ytsoob.Modules.Subscriptions.Subscriptions.ValueObjects.Description", "Description", b1 =>
                        {
                    ...
                    b.OwnsOne("Ytsoob.Modules.Subscriptions.Subscriptions.ValueObjects.Price", "Price", b1 =>
                        {
                            b1.Property<long>("SubscriptionId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Ytsoob.Modules.Subscriptions.Subscriptions.ValueObjects.Title", "Title", b1 =>
                        {
                            b1.Property<long>("SubscriptionId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
