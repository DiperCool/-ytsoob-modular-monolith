...
public static class ModuleExtensions
{
  ...
  {
    IServiceCollection newServiceCollection = useCompositionRootForModules
      ? services.CreatNewServiceCollection()
      : services;
  ...
  {
    return CompositionRootRegistry.GetByModuleByAssemblyName(
  ...
  {
    foreach (
      string file in Directory.GetFiles(root, "*.appsettings.json", SearchOption.AllDirectories)
    )
    {
